...
const DOM = {
    ...
    innerHTMLTransaction(transaction, index) {
        ...
        const html = `
            ...
            <td>
                <img id="tRemove" onclick="Transaction.remove(${index})" src="assets/minus.svg" alt="Remover Transação">
            </td>
        `
        return html
    },
...
const Form = {
    ...
    submit(event) {
        ...
        try {
            ...
            const transaction = Form.formatValues() //-----Capta transação formatada
